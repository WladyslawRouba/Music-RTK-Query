...
import type { PlaylistDataView, UpdatePlaylistArgs } from '@/features/playlists/api/playlistsApi.types.ts';
import { useState } from 'react';
import { useDeletePlaylistMutation } from '@/features/playlists/api/playlistsApi.ts';
import { handleErrors } from '@/common/utils';

type Props = {
  playlists: PlaylistDataView[];
...
export const PlaylistList = ({ playlists, isPlayListsLoading }: Props) => {
  ...
  const editPlaylistHandler = (playlist: null | PlaylistDataView) => {
    if(playlist){
